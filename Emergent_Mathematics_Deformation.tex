...
If $x=(x^1,\ldots,x^n)$ is a coordinate chart on $U\subseteq Q$, the
canonical tangent-bundle chart is
\[
TQ|_U\longrightarrow x(U)\times\R^n,
\qquad
v\in T_qQ\longmapsto
\bigl(x(q),v(x^1),\ldots,v(x^n)\bigr),
\]
and the cotangent bundle has the dual bundle chart.
\end{definition}
