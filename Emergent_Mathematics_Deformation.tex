...
\begin{definition}[\texorpdfstring{$\C$}{C}-linear and
\texorpdfstring{$C^*$}{C*}-tensor categories]
...
\begin{definition}[Corepresentation tensor categories]
...
\begin{definition}[Duals and rigidity]
...
\begin{definition}[Universal $R$-matrices]
...
\begin{definition}[Braided tensor categories]
...
\begin{definition}[Six-vertex row transfer]
...
\begin{definition}[Temperley--Lieb category and algebras]
...
\begin{definition}[Tensor ideals and unitary fusion categories]
...
\begin{definition}[Levin--Wen string-net Hamiltonian]
...
\begin{definition}[String-net loop operators]
...
\begin{definition}[Elliptic face weights and dynamical exchange]
...
\begin{definition}[Vertex--face intertwiners]
...
\begin{definition}[Terminating elliptic \texorpdfstring{$6j$}{6j} series]
