...
\begin{supplied}[Operator-algebraic foundations for conformal nets]
We take as supplied normal and locally normal representations of von
Neumann algebras, von Neumann tensor products, Tomita--Takesaki modular
theory, and the type-III nature and Reeh--Schlieder property of local
algebras. We also take as structural hypotheses Haag duality, the split
property, strong additivity, and the localization and transportability
results of DHR sector theory. The exercises below use these inputs to expose
the passage from local algebras and Jones index to fusion and braiding.
\end{supplied}
...
light ray and $\mathcal A(I)$ consists of observables localized in $I$.
\end{definition}

\begin{exercise}[The two-interval subfactor]
For $E=I_1\cup I_2$ a union of disjoint intervals, set
$\mathcal A(E)=\mathcal A(I_1)\vee\mathcal A(I_2)$. Use locality to obtain
the inclusion
\[
...
A \emph{DHR sector} of $\mathcal A$ is represented by a transportable
endomorphism $\rho$ of the quasilocal algebra that acts identically on
$\mathcal A(I')$ for some interval $I$. Composition is the tensor product;
transporting two localized endomorphisms past one another gives their
braiding. For a finite-index irreducible sector localized in $I$, its
statistical dimension satisfies
\[
...
additive, with finite $\mu$-index. Using the multi-interval subfactor, prove
that there are finitely many irreducible DHR sectors $\rho_i$, their
braiding is nondegenerate, and
\[
