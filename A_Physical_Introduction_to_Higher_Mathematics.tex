...
\chapter{Linear Structure and Spectra}
...
\chapter{Oscillation and Fourier Analysis}
...
\chapter{Continuous Symmetry and Angular Momentum}
...
\chapter{Manifolds, Forms, and Metrics}
...
\chapter{Connections, Curvature, and Field Equations}
...
\chapter{Hamiltonian and Statistical States}
...
\chapter{Hilbert-Space and Algebraic States}
...
\chapter{Completely Bounded Structure and Correlations}
...
Prove that the classical XOR value is
$\sup_{a_x,b_y=\pm1}|\sum M_{xy}a_xb_y|$ and that the quantum value is
$\sup_{\|u_x\|,\|v_y\|\leq1}|\sum M_{xy}\langle u_x,v_y\rangle|$.
...
\chapter{Homotopy, Cohomology, and Bundles}
...
\chapter{Tensor Categories, Subfactors, and Topological Physics}
