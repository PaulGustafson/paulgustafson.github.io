...
\emph{Question.} Can the probability distributions of every rotated combination of position and momentum reconstruct an oscillator state and predict its measured evolution?
...
\emph{Question.} Given a system's energy as a function of position and momentum and an initial state, what trajectory and oscillation period follow?
...
\emph{Question.} How does an order-dependent phase between microscopic translations change the allowed energy bands in a periodic material?
...
\emph{Question.} For a charged particle confined to a periodic surface, which magnetic fields permit globally consistent wavefunctions, and how many states occur at each energy?
...
\emph{Question.} What energy levels and driven transition strengths arise for particles on a ring with inverse-square repulsion?
...
\emph{Question.} For three spins with a known directional anisotropy, what probabilities result when they are coupled and exchanged in different orders?
...
\emph{Question.} For identical particles confined to a ring, how do exchange and winding rules determine their energy levels and transition strengths?
...
\emph{Question.} When can local interactions in a periodic lattice be rearranged without changing its boundary statistics or correlation length?
...
\emph{Question.} When particles have only finitely many charge types, which total charges can they form, and how does moving one around another change an interference pattern?
...
\emph{Question.} How many microscopic states have a specified energy or particle number, and how rapidly does that count grow?
...
\emph{Question.} What density, level spacings, and extreme-value fluctuations should the energy levels of a large chaotic system exhibit?
...
\emph{Question.} When two large disordered Hamiltonians with unrelated eigenstates act additively, what density of energy levels results?
...
\emph{Question.} For a surface built by random local growth, what are its long-time mean shape, height-fluctuation scale, correlation length, and limiting height distribution?
