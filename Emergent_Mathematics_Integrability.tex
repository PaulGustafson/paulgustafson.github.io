...
Let $\mathfrak g$ be a complex simple Lie algebra and normalize its invariant
...
identity.  For the simply connected compact real form construct the
corresponding $U(1)$-central extension of its smooth loop group at an integer
